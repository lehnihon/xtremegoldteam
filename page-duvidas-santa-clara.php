				...
				<div class="col-md-12">
					<div class="wrap-duv">
						<div class="cabecalho-duv clearfix text-left">
							<img class="botao-efeito closed img-responsive" src="<?php echo dirname( get_bloginfo('stylesheet_url'))."/images/botao-mais.png"?>" /><span>Quem treina na unidade Santa Clara, pode treinar na unidade Tatuapé também?</span>
						</div>
					...
					<div class="wrap-duv">
						<div class="cabecalho-duv clearfix text-left">
							<img class="botao-efeito closed img-responsive" src="<?php echo dirname( get_bloginfo('stylesheet_url'))."/images/botao-mais.png"?>" /><span>Tem cantina que vende lanches naturais dentro da academia?</span>
						</div>
						<div class="conteudo-duv tabela text-left" style="display:none">
							Sim, temos uma cantina com lanches naturais dentro da academia.
						</div>
					</div>
					<div class="wrap-duv">
						<div class="cabecalho-duv clearfix text-left">
					...
					<div class="wrap-duv">
						<div class="cabecalho-duv clearfix text-left">
							<img class="botao-efeito closed img-responsive" src="<?php echo dirname( get_bloginfo('stylesheet_url'))."/images/botao-mais.png"?>" /><span>Qual é o endereço da unidade Santa Clara?</span>
						</div>
						<div class="conteudo-duv tabela text-left" style="display:none">
							Ficamos localizado na Rua Buenópolis 134, na Santa Clara.
						</div>
					</div>
					<div class="wrap-duv">
						<div class="cabecalho-duv clearfix text-left">
